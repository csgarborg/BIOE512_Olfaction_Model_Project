...
%The submodel that is the olfactory model based off from Suzuki et al
%(2002.) The equations and rate constants are from Suzuki et al (2002.).
%Code was written and designed by team 3. The model also features a custom
%pulse width modulator that can determine how long each exposure of odorant
%species the model is, as well as the number of exposures and the delays
